...
CREATE TABLE `diet_recommendations` (
  ...
  `carbs_ratio` decimal(4,2) NOT NULL,
  `protein_ratio` decimal(4,2) NOT NULL,
  `fat_ratio` decimal(4,2) NOT NULL,
  `recommendation_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `diet_recommendations_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `diet_recommendations`
--

LOCK TABLES `diet_recommendations` WRITE;
/*!40000 ALTER TABLE `diet_recommendations` DISABLE KEYS */;
/*!40000 ALTER TABLE `diet_recommendations` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-12-11  1:52:54
